...
final Runnable dialogRunnable = new Runnable() 
{
	public void run() 
	{
        ...
        .setMessage("Set your destination")
        ...
        .setPositiveButton("Set Destination", new OnClickListener()
        {
        	@Override
        	public void onClick(DialogInterface dialog, int which) 
        	{
        		...
        		i.putExtra("myAddress",MYAddress);
        		i.putExtra("lat",pushLat);
        		i.putExtra("lng",pushLng);
        		i.putExtra("msg",message);
        		i.putExtra("num",DriverNumber);
